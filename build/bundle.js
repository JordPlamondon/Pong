...
var Game = function () {
	function Game(element, width, height) {
		...
		this.paddleOne = new _Paddle2.default(this.width, this.paddleWidth, this.paddleHeight, this.boardGap, (this.height - this.paddleHeight) / 2, _settings.KEYS.a, _settings.KEYS.z);

		this.paddleTwo = new _Paddle2.default(this.width, this.paddleWidth, this.paddleHeight, this.width - this.boardGap - this.paddleWidth, (this.height - this.paddleHeight) / 2, _settings.KEYS.up, _settings.KEYS.down);
	}
...
var Board = function () {
  ...
  _createClass(Board, [{
    ...
    value: function render(svg) {
      ...
      rect.setAttributeNS(null, 'fill', 'rgba(0, 12, 116, 0.6)');
